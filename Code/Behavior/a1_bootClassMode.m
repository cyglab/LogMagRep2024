...
bootClass.te=squeeze(te0);
bootClass.para=squeeze(para0);
bootClass.E=squeeze(E0);

savepath='./';
save(strcat(savepath,'bootClass.mat'),'bootClass');
clear bootClass;
